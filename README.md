# Тема: "Расчет энергии дата-центра"
#### Задание
- Расчитать объем потребляемой датацентром электроэнергии в зависимости от оборудования в нем. Услуги - виды устройств (серверы, коммутаторы, СХД и тд), заявка - расчет потреблямой мощности с учетом охлаждения для датацентра со списком оборудования
#### Лабораторная 4
